  ...
  return (
    <div className="mx-auto w-full ">
      <div className=" w-full flex mt-10 md:mt-40 space-x-6 justify-center items-center ">
        <a href="https://www.linkedin.com/in/ale-david-alvarez" target="_blank">
          {/* svg linkedin logo */}

          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className="h-9 w-9 md:h-10 md:w-10 hover:cursor-pointer"
            fill="rgb(244 63 94)"
          >
            <path
              id="XMLID_802_"
        ...
        <a href="https://github.com/aalvag" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
