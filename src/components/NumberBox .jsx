  ...
  return (
    <div className="flex flex-col items-center mt-4 px-2">
      <div className=" relative bg-transparent flex flex-col items-center justify-center rounded-lg w-32 h-32 text-2xl md:text-4xl mt-4 ">
        ...
        <div className="text-5xl absolute text-rose-500 z-10 font-bold font-redhat md:text-7xl font-mono ">{num}</div>
      ...
      <p className="text-lg mt-3 font-semibold text-rose-200 md:text-2xl ">{unit}</p>
    </div>
  );
};
